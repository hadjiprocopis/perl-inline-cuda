#ifndef CPU_MATRIX_OPS_DOUBLE_C
#define CPU_MATRIX_OPS_DOUBLE_C

/* our $VERSION = 0.05; */

#include <inlinecuda/utils.h>
#include <inlinecuda/cpu_matrix_ops_double.h>
...
int cpu_matrix_mult_double(
	...
	if( noisy > 0 ){
		...
		fprintf(stdout, "cpu_matrix_mult_double() : done matrix multiplication of (%zu,%zu) x (%zu,%zu) in %lf seconds.\n", m, n, n, k, time_difference_seconds(TSTARTED, TENDED));
	}
	return 0; // success
}
