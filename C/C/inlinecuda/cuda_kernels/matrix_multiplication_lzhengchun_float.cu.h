#ifndef _MATRIX_MULTIPLICATION_LZHENGCHUN_FLOAT_CU_H
#define _MATRIX_MULTIPLICATION_LZHENGCHUN_FLOAT_CU_H
...
*/
__global__
void gpu_matrix_mult_lzhengchun_float(float *a,float *b, float *c, int m, int n, int k);
...
*/
__global__
void gpu_square_matrix_mult_lzhengchun_float(float *d_a, float *d_b, float *d_result, int n);
...
*/
__global__
void gpu_matrix_transpose_lzhengchun_float(float* mat_in, float* mat_out, unsigned int rows, unsigned int cols);
