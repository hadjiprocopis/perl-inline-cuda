#ifndef _MATRIX_MULTIPLICATION_LZHENGCHUN_DOUBLE_CU_H
#define _MATRIX_MULTIPLICATION_LZHENGCHUN_DOUBLE_CU_H
...
*/
__global__
void gpu_matrix_mult_lzhengchun_double(double *a,double *b, double *c, size_t m, size_t n, size_t k);
...
*/
__global__
void gpu_matrix_transpose_lzhengchun_double(
	double* mat_in,
	double* mat_out,
