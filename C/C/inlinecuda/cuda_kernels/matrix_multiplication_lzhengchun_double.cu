#ifndef _MATRIX_MULTIPLICATION_LZHENGCHUN_DOUBLE_CU
#define _MATRIX_MULTIPLICATION_LZHENGCHUN_DOUBLE_CU

/* our $VERSION = 0.05; */

#include <inlinecuda/cuda_kernels/matrix_multiplication_lzhengchun_double.cu.h>
...
/*
*********************************************************************
function name: gpu_matrix_mult_lzhengchun_double
...
*********************************************************************
*/
__global__ void gpu_matrix_mult_lzhengchun_double(double *a,double *b, double *c, size_t m, size_t n, size_t k)
{ 
...
/*
*********************************************************************
function name: gpu_square_matrix_mult_lzhengchun_double
...
*/
__global__
void gpu_square_matrix_mult_lzhengchun_double(double *d_a, double *d_b, double *d_result, size_t n) {
...
/*
*********************************************************************
function name: gpu_matrix_transpose_lzhengchun_double
...
*********************************************************************
*/
__global__ void gpu_matrix_transpose_lzhengchun_double(double* mat_in, double* mat_out, size_t rows, size_t cols) 
{
