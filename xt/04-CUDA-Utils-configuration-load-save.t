...
$conf = Inline::CUDA::Utils::load_configuration();
ok(defined($conf), "Inline::CUDA::Utils::load_configuration() : called for default shared-dir conf file: '$default_conf_file'.");
...
$newconf = Inline::CUDA::Utils::load_configuration($tmpfilename);
ok(defined($conf), "Inline::CUDA::Utils::load_configuration() : called for '$tmpfilename'.");
...
if( -W $default_conf_file ){
	...
	# load what we just saved
	$newconf = Inline::CUDA::Utils::load_configuration();
	ok(defined($conf), "Inline::CUDA::Utils::load_configuration() : called for default-location configuration file '$default_conf_file'.");
