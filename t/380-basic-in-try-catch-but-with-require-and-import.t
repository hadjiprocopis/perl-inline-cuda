...
ok(!defined($failed)||($failed eq ''), "returned good result.") or BAIL_OUT("failed: $failed");
...
ok(defined($failed)&&($failed ne ''), "failed as expected because of bogus configuration.") or BAIL_OUT("failed to fail");
