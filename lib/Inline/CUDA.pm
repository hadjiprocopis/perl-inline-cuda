...
# BLIAKO: end addition
   ...
   # care should be taken for spaces and quotes!
    print STDOUT "validate() : reading configuration from file '".Inline::CUDA::Utils::path_of_configuration_file_in_shared_dir()."' ...\n";
...
then you can omit this: C<--compiler-bindir /usr/local/gcc82/bin/gcc82>.
